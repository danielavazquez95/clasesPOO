import { Diseñador } from "./Diseñador";
...
export class Empresa {
  ...
  agregarEmpleados(nombre, apellido, edad, id, profesion, lenguaje, tipo){ // Todos los métodos que se encuentran fuera del constructor estarán en el prototipo de los objetos que se instanciarán.
      if (profesion.toLowerCase() === 'programador'){ 
       const programador = new Programador(nombre, apellido, edad, id, lenguaje);// Se crea una nueva instancia de la clase Programador.
        this.empleados.push(programador);
      } else if (profesion.toLowerCase() === 'diseñador') {
        const diseñador = new Diseñador (nombre, apellido, edad, id, tipo);// Se crea una nueva instancia de la clase Diseñador.
